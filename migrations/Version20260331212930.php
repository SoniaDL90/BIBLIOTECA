 ...
 */
final class Version20260331212930 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE loan (id INT AUTO_INCREMENT NOT NULL, fecha_prestamo DATETIME NOT NULL, fecha_devolucion_prevista DATETIME NOT NULL, fecha_devolucion_real DATETIME DEFAULT NULL, estado VARCHAR(255) NOT NULL, user_id INT NOT NULL, book_id INT NOT NULL, INDEX IDX_C5D30D03A76ED395 (user_id), INDEX IDX_C5D30D0316A2B381 (book_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
